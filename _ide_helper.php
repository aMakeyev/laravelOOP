 ...
 * Generated for Laravel 4.2.22 on 2017-04-29.
 *
...
namespace {
    ...
    class AuthController extends \Calc\Controller\AuthController{
        
    }


    class DashboardController extends \Calc\Controller\DashboardController{
        
    }


    class ManagersController extends \Calc\Controller\ManagersController{
        
    }


    class CalculationController extends \Calc\Controller\CalculationController{
        
    }


    class OrdersController extends \Calc\Controller\OrdersController{
        
    }


    class ContractorsController extends \Calc\Controller\ContractorsController{
        
    }


    class ClientsController extends \Calc\Controller\ClientsController{
        
    }


    class PartsController extends \Calc\Controller\PartsController{
        
    }


    class CoefficientsController extends \Calc\Controller\CoefficientsController{
        
    }


    class ProfileController extends \Calc\Controller\ProfileController{
        
    }


    class MakeOrderController extends \Calc\Controller\MakeOrderController{
        
    }


    class ElementsController extends \Calc\Controller\ElementsController{
        
    }


    class UserPresenter extends \Calc\Presenters\UserPresenter{
        
    }


    class ClientPresenter extends \Calc\Presenters\ClientPresenter{
        
    }


    class ContractorPresenter extends \Calc\Presenters\ContractorPresenter{
        
    }


    class PartPresenter extends \Calc\Presenters\PartPresenter{
...
namespace Api{
    ...
    class ManagersController extends \Calc\Controller\Api\ManagersController{
        
    }


    class CalculationsController extends \Calc\Controller\Api\CalculationsController{
        
    }


    class OrdersController extends \Calc\Controller\Api\OrdersController{
        
    }


    class ContractorsController extends \Calc\Controller\Api\ContractorsController{
        
    }


    class ClientsController extends \Calc\Controller\Api\ClientsController{
        
    }


    class PartsController extends \Calc\Controller\Api\PartsController{
        
    }


    class CoefficientsController extends \Calc\Controller\Api\CoefficientsController{
        
    }


    class AdditionalCoefficientsController extends \Calc\Controller\Api\AdditionalCoefficientsController{
        
    }


    class ConstructorsRatesController extends \Calc\Controller\Api\ConstructorsRatesController{
        
    }


    class GroupsPartsController extends \Calc\Controller\Api\GroupsPartsController{
        
    }


    class VariablesController extends \Calc\Controller\Api\VariablesController{
        
    }


    class HelpersController extends \Calc\Controller\Api\HelpersController{
        
    }


    class FilesController extends \Calc\Controller\Api\FilesController{
        
    }


    class ElementsController extends \Calc\Controller\Api\ElementsController{
