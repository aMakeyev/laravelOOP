...
$(document).ready(function () {
  ...
  var grid = $('#shaters_calculations'),
    queryData = {};

  App.calculation = new Services.GridResource('/shaters/api/calculations', {
    grid: grid
  }, {
    remove: {
  ...
  var columns = [{
    ...
    formatter: function (value, row) {
      return '<a target="_blank" href="/shaters/calculation/' + row.id + '/edit">' + value + '</a>';
    }
  }, {
    field: 'status',
    title: 'Статус',
    ...
    align: 'center',
    formatter: function (value, row) {
      return '<a target="_blank" href="/shaters/clients/' + row.client.id + '">' + fullName(row.client) + '</a>';
    }
  }, {
    field: 'cost_final',
    title: 'Сумма, руб.',
    ...
    formatter: function (value, row, index) {
      ...
      btns += '<a target="_blank" href="/shaters/calculation/' + row.id + '/edit" class="btn btn-link btn-xs"><span class="glyphicon glyphicon-pencil"></span></a>';
      ...
      btns += '<a target="_blank" href="/shaters/calculation/' + row.id + '" class="btn btn-link btn-xs"><span class="glyphicon glyphicon-eye-open"></span></a>';
      btns += '</div>';
      return btns
    }
  }];
  ...
  $('#search').searchbox({
    prompt: 'Поиск по заказчику и № заказа...',
