$(document).ready(function () {
  ...
  var сolumns = [{
    ...
    formatter: function (value, row, index) {
      ...
      btns += '<a href="/shaters/clients/' + row.id + '" class="btn btn-link btn-xs"><span class="glyphicon glyphicon-eye-open"></span></a>';
      btns += '</div>';
      return btns
    }
  }];
  ...
  $('#status').combobox({
    valueField: 'id',
    textField: 'title',
    url: '/shaters/api/clients-statuses/all',
    method: 'get',
    panelHeight: 'auto',
  ...
  $('#type').combobox({
    valueField: 'id',
    textField: 'title',
    url: '/shaters/api/clients-types/all',
    method: 'get',
    panelHeight: 'auto',
    onSelect: function (row) {
  ...
  $('#manager').combobox({
    valueField: 'id',
    textField: 'text',
    url: '/shaters/api/managers-list/all',
    method: 'get',
    panelHeight: 'auto',
    onSelect: function (row) {
