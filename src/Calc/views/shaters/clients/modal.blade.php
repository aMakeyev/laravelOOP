...
<div class="modal" id="shaters_client_modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <form id="client_form" method="post" action="" onsubmit="App.client.{{ $obj->exists ? 'update' : 'store' }}(this);return false;">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="alert alert-info">
                                Ввод данных частного лица или организации, а также загрузка файлов будут доступены после сохранения заказчика.
                            </div>
                        </div>
                    </div>
                    @endif
                    ...
                    @if ($obj->exists)
                        <div ng-app="Calc">
                            <div ng-controller="ShatersClientCtrl as calc">
    ...
    <script>
		...
		$("#shaters_client_modal").on("hidden.bs.modal", function () {
		...
		(function () {
			...
			function CalcController($scope, $http, FileUploader, Notify) {
				...
				this.uploader = new FileUploader({
					url: '/api/files/upload/shatersclient/',
			...
			angular
				.module('Calc')
				.controller('ShatersClientCtrl', CalcController);
		})();
