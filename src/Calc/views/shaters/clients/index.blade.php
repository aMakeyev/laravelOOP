    ...
    <div class="col-sm-12">
        <h1>
            ...
            @if(Auth::user()->id == 8 || Auth::user()->id == 26 || Auth::user()->id == 25)
                {{--<a class="btn btn-info" href="clients/xls">Список заказчиков в Excel</a>--}}
            @endif
        </h1>
    </div>
</div>
<div id="toolbar" class="toolbar">
    ...
    Менеджер <input type="text" id="manager"/><div class="d-mobile"></div>
    <input type="text" id="search" style="width: 250px"/>
</div>
<table id="shaters_clients"></table>
...
<style>
    ...
    @media only screen and (max-width : 415px) {
        ...
        .datagrid-cell-c1-id {width:29px !important;}

        .datagrid-cell-c1-next_contact_at {width:73px !important;}

        .datagrid-cell-c1-description {width:74px !important;}
...
@stop
@section('scripts')
<script src="/static/js/src/shaters/clients.js"></script>
@stop
