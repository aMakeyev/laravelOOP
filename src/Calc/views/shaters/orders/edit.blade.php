...
<div id="calculation" ng-app="Calc">
    <div ng-controller="ShatersOrdersCtrl as calc">
        <div class="calc">
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="title">
    ...
    <div class="row">
        ...
        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
            ...
            <div class="row">
                ...
                <div class="col-sm-2">
                    <input type="text" class="form-control text-center input-sm incomeValue" placeholder="Сумма" ng-model="calc.income.value" ng-value="calc.income.value"/>
                </div>
                <div class="col-sm-5">
...
{{--                    {{ Form::select('status', Config::get('calc::income/statuses'), '', ['class' => 'form-control cars', 'ui-select2' => 'calc.select2.default', 'ng-model' => 'calc.income.status']) }}--}}
                   {{-- <select class="cars form-control" ng-model="calc.income.status">
...
<script src="/static/js/app/controllers/ShatersOrderController.js"></script>
