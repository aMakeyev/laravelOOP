...
<div id="elements" ng-app="ShatersElements">
    <div ng-controller="ShatersElementsCtrl as elem">
    ...
    <script type="text/ng-template" id="node_category_edit.html">
        <div class="node-editing node-editing-category">
            ...
            <label class="node_type"><input type="radio" ng-model="category.type" value="1"/> Шаттерс</label>
...
<script src="/static/js/app/shaterselements/app.js"></script>
<script src="/static/js/app/shaterselements/controller.js"></script>
<script src="/static/js/app/shaterselements/TreeService.js"></script>
