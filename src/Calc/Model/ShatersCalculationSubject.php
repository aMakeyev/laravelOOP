...
class ShatersCalculationSubject extends BaseModel
{
    use Titleable;
     ...
     * @var string
     */
    protected $table = 'shaters_calculations_subjects';
    ...
    {
        return $this->hasMany('Calc\Model\ShatersSubjectElement', 'subject_id');
    }
