...
class ShatersPart extends BaseModel
{
    use PresentableTrait, Titleable;

    protected $presenter = 'ShatersPartPresenter';
    ...
    {
        return $this->belongsTo('Calc\Model\ShatersPartGroup');
    }

    public function subjectElements()
    {
        return $this->hasMany('Calc\Model\ShatersSubjectElement', 'part_id');
    }
