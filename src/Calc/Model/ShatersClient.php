...
class ShatersClient extends BaseModel
{
     ...
     * @var string
     */
    protected $table = 'shaters_clients';
	...
	protected $morphClass = 'ShatersClient';
    ...
    {
        return $this->hasMany('Calc\Model\ShatersCalculation', 'client_id');
    }
    ...
    {
        return $this->hasManyThrough('Calc\Model\ShatersOrder', 'Calc\Model\ShatersCalculation', 'client_id', 'calculation_id');
    }
