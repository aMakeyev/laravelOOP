 ...
 * @property $cost_final
 */
class ShatersCalculation extends BaseModel
{
     ...
     * @var string
     */
    protected $table = 'shaters_calculations';
     ...
     * @var string
     */
    protected $morphClass = 'ShatersCalculation';
    ...
    public static function boot()
    {
        ...
        self::deleting(function (self $model) {
            ...
            /** @var ShatersCalculationSubject $subject */
    ...
    {
        return $this->belongsTo('Calc\Model\ShatersClient', 'client_id');
    }
    ...
    {
        return $this->hasMany('Calc\Model\ShatersOrder', 'calculation_id');
    }
    ...
    {
        return $this->hasMany('Calc\Model\ShatersCalculationSubject', 'calculation_id');
    }
    ...
    {
        return $this->hasMany('Calc\Model\ShatersIncome', 'calculation_id');
    }
    ...
    public function setClientAttribute($value)
    {
        if (is_array($value) && isset($value['id'])) {
            ...
            if ($value instanceof ShatersClient) {
                $value = $value->id;
            }
        }
