...
class ShatersSubjectElement extends BaseModel
{
    use Titleable;
     ...
     * @var string
     */
    protected $table = 'shaters_subjects_elements';
    ...
    {
        return $this->belongsTo('Calc\Model\ShatersCalculationSubject', 'subject_id');
    }

    public function element()
    {
        return $this->belongsTo('Calc\Model\ShatersElement', 'character');
    }

    public function part()
    {
        return $this->hasOne('Calc\Model\ShatersPart', 'id', 'part_id');
    }
    ...
    public function setPartAttribute($value)
    {
        ...
        else if ($value instanceof ShatersPart)
        {
