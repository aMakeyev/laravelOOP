...
class ShatersPartsController extends BaseController
{
     ...
     * @var string
     */
    protected $repositoryClassName = 'Calc\Repo\ShatersPartRepo';
    /**
     * @var \Calc\Repo\ShatersPartRepo
     */
    ...
    {
        return $this->response->data([
            'modal' => view('calc::shaters.parts.modal')
                ->with('obj', $this->repository->newEmpty())
                ->with('groups', ShatersPartGroup::lists('title', 'id'))
                ->render(),
    ...
    public function edit($id)
    {
        return $this->response->data([
            'modal' => view('calc::shaters.parts.modal')
                ...
                ->render(),
            'modal_id' => self::MODAL_ID,
            'groups'   => ShatersPartGroup::lists('id', 'title')
        ]);
    }
    ...
    {
        /** @var \Calc\Model\ShatersPart $obj */
        $obj = $this->repository->find($id);
