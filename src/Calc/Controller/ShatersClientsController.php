...
class ShatersClientsController extends BaseController
{
    ...
    {
        $this->layout->content = view('calc::shaters.clients.index');
    }

    public function show($id)
    {
        /** @var ShatersClient $obj */
        $obj = ShatersClient::findOrFail($id);
        $this->title->prepend($obj->present()->fullName);
        $this->layout->content = view('calc::shaters.clients.show')->with('obj', $obj);
    }
